...
const Ranger = () => {
    ...
    useEffect(() => {
        ...
        let foundObjects = data.filter(obj => obj["class"] && obj["class"].index === "ranger");
        ...
        {classTable ? (
            <>
                ...
                <thead className="table-primary">
                    <tr>
                        <th style={{...headerStyle, textAlign: "center"}} colSpan="5"></th>
                ...
                <tbody>
                    ...
                    <tr key={index}>
                        ...
                        <td style={{...cellStyle, textAlign: "center"}}>
                            {level["spellcasting"] && level["spellcasting"]["spells_known"] 
