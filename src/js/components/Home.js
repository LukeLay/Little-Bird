...
import ReturnToTopButton from "../tools/ReturnToTopButton";
...
const Home = () => {       
    ...
    return (
        <> 
            ...
            <div className="card text-white bg-dark mb-3 border-primary" style={{ margin: "1%", width: "48%", opacity: 0.95 }}>
                                    ...
                                    part.startsWith("#") ? (
                                        ...
                                        <span
                                            ...
                                            __html: part
                                                ...
                                                `<span style="color: var(--bs-info); font-weight: bold">${word}</span>`
                                                )),
                                            }}
                                        />
                                        </p>
