...
class MultiDice extends Component {
  ...
  render() {
    ...
    return (
      <div className="card border-primary mb-3" style={{ width: "98%", marginLeft: "1%", marginRight: "12.5%", display: "flex", flexDirection: "column", borderRadius: "16px" }}>
        ...
        <div className="card-body" style={{ display: "flex", flexDirection: "column" }}>
          ...
          <table style={{ margin: "2%" }}>
            ...
            <tbody>
              ...
              <tr>
                <td style={{ width: "50%", border: "2px solid var(--bs-info)", textAlign: "center" }}>Individual Rolls</td>
                <td style={{ width: "50%", border: "2px solid var(--bs-info)", textAlign: "center" }}>{rolls.join(', ')}</td>
              </tr>

              <tr>
                <td style={{ width: "50%", border: "2px solid var(--bs-info)", textAlign: "center" }}>Total</td>
                <td style={{ width: "50%", border: "2px solid var(--bs-info)", textAlign: "center" }}>{total}</td>
              </tr>
