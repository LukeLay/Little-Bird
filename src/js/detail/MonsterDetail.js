    ...
    <>
      ...
      {monster ? (
        <>
          ...
          <BackGroundImage image={`public/img/monsters/${monster["index"]}.png`} />
                ...
                <div style={{ display: "flex", flexDirection: "row" }}>
                  ...
                  <div style={{ width: "66.66%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                    ...
                    <table className="table table-hover" style={{ width: "98%", margin: "1%" }}>
                      ...
                      <tbody>
                        <tr className="table-dark">
                          <td><div style={cellStyle}>{monster && monster["strength"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["strength"])})</span></div></td>
                          <td><div style={cellStyle}>{monster && monster["dexterity"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["dexterity"])})</span></div></td>
                          <td><div style={cellStyle}>{monster && monster["constitution"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["constitution"])})</span></div></td>
                          <td><div style={cellStyle}>{monster && monster["intelligence"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["intelligence"])})</span></div></td>
                          <td><div style={cellStyle}>{monster && monster["wisdom"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["wisdom"])})</span></div></td>
                          <td><div style={cellStyle}>{monster && monster["charisma"]} <span style={{ opacity: "0.25" }}>&nbsp;({getAbilityModifier(monster["charisma"])})</span></div></td>
                        </tr>
                      </tbody>
                    </table>
